import { z } from "zod";
export function registerProjectUserAssignmentTools(server, client) {
    server.registerTool("list_all_user_assignments", {
    ...
    server.registerTool("list_project_user_assignments", {
    ...
    server.registerTool("get_project_user_assignment", {
    ...
    server.registerTool("create_project_user_assignment", {
    ...
    server.registerTool("update_project_user_assignment", {
    ...
    server.registerTool("delete_project_user_assignment", {
...
//# sourceMappingURL=project-user-assignments.js.map