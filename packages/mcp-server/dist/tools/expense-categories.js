import { z } from "zod";
export function registerExpenseCategoryTools(server, client) {
    ...
    server.registerTool("get_expense_category", {
    ...
    server.registerTool("create_expense_category", {
    ...
    server.registerTool("update_expense_category", {
    ...
    server.registerTool("delete_expense_category", {
        ...
        inputSchema: z.object({
            expense_category_id: z.number().describe("The expense category ID to delete"),
        }),
    }, async (args) => {
        await client.deleteExpenseCategory(args.expense_category_id);
        return {
