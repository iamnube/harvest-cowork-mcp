...
export function registerReportTools(server, client) {
    server.registerTool("time_report_by_clients", {
    ...
    server.registerTool("time_report_by_projects", {
    ...
    server.registerTool("time_report_by_tasks", {
    ...
    server.registerTool("time_report_by_team", {
    ...
    server.registerTool("project_budget_report", {
    ...
    // --- Uninvoiced Report ---
    server.registerTool("uninvoiced_report", {
    ...
    // --- Expense Reports ---
    server.registerTool("expense_report_by_clients", {
    ...
    server.registerTool("expense_report_by_projects", {
    ...
    server.registerTool("expense_report_by_categories", {
    ...
    server.registerTool("expense_report_by_team", {
