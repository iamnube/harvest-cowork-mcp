...
export function registerTaskTools(server: McpServer, client: HarvestClient) {
  server.registerTool(
    "list_tasks",
    {
      title: "List Tasks",
      description:
        "List all tasks available in Harvest. Tasks are the activity types (e.g. 'Development', 'Design') that can be assigned to projects.",
